namespace google.controller { 
   export enum GoogleButtonEvent {
    ...
    export enum GoogleControllerButton {
        //% block="{id:google}A"
        A = 5,
        //% block="{id:google}B"
        B = 6,
    ...
    enum GoogleControllerEvent {
        ...
        export class Button {
            ...
            //% blockId=googlekeyonevent block="on %button **button** %event"
            //% group="Single Player"
            onEvent(event: GoogleControllerEvent, handler: () => void) {
            ...
            // blockId=googlekeypauseuntil block="pause until %button **button** is %event"
            //% group="Single Player"
            pauseUntil(event: GoogleButtonEvent) {
            ...
            */
            ...
            //% blockId=googlekeyispressed block="is %button **button** pressed"
            //% group="Single Player"
            isPressed() {
        ...
        export class Controller {
            ...
            //%
            get left() {
                return this.button(GoogleControllerButton.Left);
            }
            ...
            //%
            get right() {
                return this.button(GoogleControllerButton.Right);
            }
            ...
            //%
            get up() {
                return this.button(GoogleControllerButton.Up);
            }
            ...
            //%
            get down() {
                return this.button(GoogleControllerButton.Down);
            }
            ...
            //%
            get A() {
                return this.button(GoogleControllerButton.A);
            }
            ...
            //%
            get B() {
                return this.button(GoogleControllerButton.B);
            }
             ...
             */
            //% blockId="google_ctrlgame_control_sprite" block="%controller move $sprite=variables_get(mySprite) with buttons||vx $vx vy $vy"
            //% weight=100
            ...
            private button(button: GoogleControllerButton): Button {
            ...
            //% blockId=googlectrlonbuttonevent block="on %controller %button **button** %event"
            //% group="Multiplayer"
            //% help=controller/on-button-event
            onButtonEvent(btn: GoogleControllerButton, event: GoogleControllerEvent, handler: () => void) {
             ...
             */
            //% weight=99 blockGap=8
            //% blockId=googlectrlonevent block="on %controller %event"
            //% group="Multiplayer"
            ...
            */
            //% weight=96 blockGap=8 help=controller/button/is-pressed
            //% blockId=googlectrlispressed block="is %controller %button **button** pressed"
            //% group="Multiplayer"
            isPressed(btn: GoogleControllerButton): boolean {
            ...
            //% blockId=googlectrldx block="%controller dx (left-right buttons)||scaled by %step"
            //% step.defl=100
            //% group="Multiplayer"
            dx(step: number = 100) {
